...
if __name__ == '__main__':
    ...
    tracker_det_model_path = os.getenv("TRACKER_DET_MODEL_PATH", "model/person-detection-0202/FP16/person-detection-0202.xml")
    tracker_reid_model_path = os.getenv("TRACKER_REID_MODEL_PATH", "model/person-reidentification-retail-0287/FP16/person-reidentification-retail-0287.xml")
