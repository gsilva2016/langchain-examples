...
from common.milvus_reid.reid_milvus import (
    insert_reid_embeddings,
    flush_final_embeddings,
    clear_reid_state,
    global_track_locks,
)
    ...
    while True:
        try:
            ...
            if frame_batch is None:
                flush_final_embeddings(milvus_manager, collection_name=collection_name)
