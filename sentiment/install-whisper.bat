...
echo "Creating conda environment %CONDA_WHISPER_ENV_NAME%."
call conda create -n %CONDA_WHISPER_ENV_NAME% python=3.11 -y
echo 'y' | conda install pip
echo Activating %CONDA_WHISPER_ENV_NAME% 
call conda activate %CONDA_WHISPER_ENV_NAME%
